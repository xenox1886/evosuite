...
import org.evosuite.coverage.custom.CustomFitnessFunctionCreator;
...
public class FitnessFunctions {
    ...
    public static TestSuiteFitnessFunction getFitnessFunction(Criterion criterion) {
        switch (criterion) {
            ...
            case CUSTOM:
                return CustomFitnessFunctionCreator.getInstance().getNewFitnessFunctionSuite();
            default:
    ...
    public static TestFitnessFactory<? extends TestFitnessFunction> getFitnessFactory(
        ...
        switch (crit) {
            ...
            case CUSTOM:
                return CustomFitnessFunctionCreator.getInstance().getNewFitnessFactory();
            default:
    ...
    public static Class<?> getTestFitnessFunctionClass(Criterion criterion) {
        switch (criterion) {
            ...
            case CUSTOM:
                return CustomFitnessFunctionCreator.getInstance().getTestFitnessFunctionClass();
            default:
