...
public interface TestCase extends Iterable<Statement>, Cloneable, Listenable<Void> {
    ...
    /**
     * If this test case contains a method call to a method under test
     * (as defined in Properties.METHOD_UNDER_TEST)
     *
     * @return if a call to a method under test is found
     */
