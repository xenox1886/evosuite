...
public class ClassPathHandler {
    ...
    /**
     * Same as {@link ClassPathHandler#addElementToTargetProjectClassPath(String)} but prepends the new element
     *
     * @param element the element to add to the cp
     * @throws IllegalArgumentException
     */
    public void prependElementToTargetProjectClassPath(String element) throws IllegalArgumentException {
        checkIfValidClasspathEntry(element);
        ...
        if (targetClassPath == null || targetClassPath.isEmpty()) {
            ...
            targetClassPath = element + File.pathSeparator + targetClassPath;
            Properties.CP = targetClassPath;
        }
    }
