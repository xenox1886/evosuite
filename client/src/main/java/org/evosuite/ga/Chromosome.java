...
//				 || ( value < 0 ) || ( ff == null )) 
    ...
    /**
     * Get the fitness functions of this chromosome
     *
     * @return a set of fitness functions
     */
    public Set<FitnessFunction<?>> getFitnessFunctions() {
        return Collections.unmodifiableSet(getFitnessValues().keySet());
    }
